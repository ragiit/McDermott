        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationOfBenefit = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AwarenessEduCategoryId = table.Column<long>(type: "bigint", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Slug = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Slugeess = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AwarenessEduCategoryId,
                        principalTable: "AwarenessEduCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReferenceAnc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PatientNextVisitSchedule = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    VisitNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KdPrognosa = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Anamnesa = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BMHP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PregnancyStatusG = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PregnancyStatusP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PregnancyStatusA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HPHT = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HPL = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LILA = table.Column<int>(type: "int", nullable: true),
                    ProjectId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Anamnesa = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MedicationTherapy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NonMedicationTherapy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "GeneralConsultanServiceAncs",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    HPHT = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HPL = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LILA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneralConsultanServiceAncs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneralConsultanServiceLogs", x => x.Id);
                    table.ForeignKey(
