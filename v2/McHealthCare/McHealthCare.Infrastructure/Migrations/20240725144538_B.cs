        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sequence = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthCenter_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HealthCenter_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HealthCenter_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "Provinces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Building_HealthCenter_HealthCenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReorderingRule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReorderingRule_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReorderingRule_Location_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BuildingLocation_Location_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Building_HealthCenterId",
                table: "Building",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildingLocation_LocationId",
                table: "BuildingLocation",
                column: "LocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthCenter_CityId",
                table: "HealthCenter",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthCenter_CountryId",
                table: "HealthCenter",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthCenter_ProvinceId",
                table: "HealthCenter",
                column: "ProvinceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReorderingRule_CompanyId",
                table: "ReorderingRule",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ReorderingRule_LocationId",
                table: "ReorderingRule",
                column: "LocationId");
