using static McHealthCare.Application.Features.Commands.ClinicServices.GeneralConsultanServiceCommand;

namespace McHealthCare.Application.Features.Queries.Transaction
{
