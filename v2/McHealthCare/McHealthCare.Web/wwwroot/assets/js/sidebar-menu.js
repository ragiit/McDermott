...
$(".mobile-back").click(function () {
    $("#sidebar-links .nav-menu").css("left", "-210px");
});
$(".page-wrapper").attr(
    "class",
...
$(document).ready(function () {
    // Function to handle active link scrolling
    function scrollToActiveLink() {
        var $simplebarWrapper = $(".simplebar-wrapper .simplebar-content-wrapper");

        if ($simplebarWrapper.length > 0 && $("#pageWrapper").hasClass("compact-wrapper")) {
            var $activeLink = $simplebarWrapper.find("a.active");

            if ($activeLink.length > 0) {
                var scrollTopValue = $activeLink.offset().top - $simplebarWrapper.offset().top + $simplebarWrapper.scrollTop() - 100;
            ...
            console.warn('Elements not found or conditions not met.');
        }
    }

    // Trigger scrollToActiveLink on page load
    scrollToActiveLink();

    // Optional: Trigger scrollToActiveLink on click of links
    ...
    // Expose the scrollToActiveLink function to be called from Blazor
    window.scrollToActiveLink = function () {
        $(document).ready(function () {
            scrollToActiveLink();
        });
    };
