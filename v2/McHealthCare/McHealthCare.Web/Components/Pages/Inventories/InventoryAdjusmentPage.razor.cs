    ...
    public partial class InventoryAdjusmentPage
    {
        ...
        private async Task OnDelete(GridDataItemDeletingEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Guid adjId = ((InventoryAdjusmentDto)e.DataItem).Id;
                ...
                else
                {
                    ...
                    if (InventoryAdjusment.Id == Guid.Empty)
                    {
                        try
                        {
                            ...
                            if (inventoryAdjusmentDetail.Id == Guid.Empty)
                            {
                                inventoryAdjusmentDetail.Id = Guid.NewGuid();
        ...
        {
            if (InventoryAdjusment.LocationId is null || InventoryAdjusment.LocationId == Guid.Empty)
            {
